...
namespace EmployeeApp.AutomatedUITests
{
    public class EmployeePage
    {
        ...
        private IWebElement AccountElement => _driver.FindElement(By.Id("AccountNumber"));
        ...
        public void PopulateAccountNumber(string accountNumber) => AccountElement.SendKeys(accountNumber);
